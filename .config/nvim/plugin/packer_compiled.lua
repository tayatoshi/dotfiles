...
_G.packer_plugins = {
  ...
  ["Nvim-R"] = {
    loaded = true,
    path = "/Users/taya/.local/share/nvim/site/pack/packer/start/Nvim-R",
  ...
  ["nvim-navic"] = {
    ...
    loaded = true,
    path = "/Users/taya/.local/share/nvim/site/pack/packer/start/nvim-navic",
  ...
  winresizer = {
    loaded = true,
    path = "/Users/taya/.local/share/nvim/site/pack/packer/start/winresizer",
